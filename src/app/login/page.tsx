        ...
        <main className="flex flex-grow items-center justify-center pt-20">
            ...
            <TabsContent value="signup">
                ...
                <CardHeader>
                    ...
                    <CardDescription>Join ZYRA and start learning.</CardDescription>
                </CardHeader>
            ...
            <div className="relative my-4">
             ...
             <Button variant="outline" className="w-full" onClick={handleGoogleSignIn} disabled={loading}>
                {loading ? <Loader2 className="animate-spin"/> : <><svg role="img" viewBox="0 0 24 24" className="mr-2 h-4 w-4"><path fill="currentColor" d="M12.48 10.92v3.28h7.84c-.24 1.84-.85 3.18-1.73 4.1-1.02 1.02-2.6 1.62-4.58 1.62-3.53 0-6.47-2.92-6.47-6.5s2.94-6.5 6.47-6.5c1.96 0 3.37.78 4.38 1.75l2.43-2.33C17.4.92 15.12 0 12.48 0 7.23 0 3.06 4.33 3.06 9.6s4.17 9.6 9.42 9.6c2.7 0 4.9-1.04 6.5-2.52 1.6-1.5 2.23-3.8 2.23-6.34 0-.48-.04-.88-.1-1.28H12.48z"></path></svg>Google</>}
            </Button>
            </Tabs>
        </main>
        <Footer />
